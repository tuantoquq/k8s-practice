...
export default function Miner() {
    ...
    const onClickCreate = () => {
        ...
        axios
            .post(Root.Miner.CreateDefault, createMiner, config)
            .then((res) => {
        ...
        <>
            ...
            <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
                <Button
                    ...
                    onClick={() => setOpenModalMinerUpdateCreate(true)}
                >
                    Add default miner
                </Button>
            </Box>
