...
import { TextField, Grid, Box, Modal, Typography, Button } from "@mui/material";
...
export default function UpdateCreateMiner(props) {
    const MinerDefault = {
        Name: "",
        RecursiveRange: "",
        InputTables: "",
        ...
        <>
            ...
            >
                <Box sx={style}>
                    ...
                    <div style={{ marginLeft: "530px" }}>{props.notice}</div>
                    <Button
